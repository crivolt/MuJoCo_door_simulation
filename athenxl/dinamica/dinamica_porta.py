...
door_joint_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_JOINT, "slide_sx") # CAMBIARE SE VOGLIO LA DX
door_qposadr = model.jnt_qposadr[door_joint_id]

# sites

site_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_SITE, "grasp_site")
target_site_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_SITE, "target_manigliasx") # CAMBIARE SE VOGLIO LA DX
weld_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_EQUALITY, "presa_sx") # CAMBIARE SE VOGLIO LA DX
...
q_home = np.array([0.753, 0.582, 0.0, -0.955, 0.0, joint6_angle, joint7_angle])
...
trajectory = np.load("/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/athenxl/traiettorie/traiettoria_sinistra.npy")
...
KP             = 1.0    
KI             = 0.05  
INTEGRAL_CLIP  = 0.03   # anti-windup
