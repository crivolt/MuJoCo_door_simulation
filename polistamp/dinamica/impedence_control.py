...
model = mujoco.MjModel.from_xml_path(
    "/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/polistamp/polistamp.xml"
)
...
trajectory = np.load(
    "/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/polistamp/traiettorie/traiettoria_apertura.npy"
)

trajectory_handle = np.load(
    "/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/polistamp/traiettorie/traiettoria_apertura_maniglia.npy"
)
    ...
    for step in range(30000):
        ...
        match phase:
            ...
            case 3:
                ...
                target_angle = np.deg2rad(-10) * (
                    handle_index / (len(trajectory_handle) - 1)
                )
        ...
        if step % 50 == 0:
            ...
            print(
                f"Tempo {time_sec:.2f} | "
                f"fase {phase} | "
                f"maniglia: {handle_angle_deg:.2f} | "
