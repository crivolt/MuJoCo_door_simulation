...
figure
subplot(2,1,1)
plot(tempo, maniglia, 'LineWidth', 1.5, 'Color', [0.85 0.33 0.10])
ylabel('Handle angle [deg]')
title('Handle opening and angular velocity')
grid on

subplot(2,1,2)
plot(tempo, vel_maniglia, 'LineWidth', 1.5, 'Color', [0.47 0.67 0.19])
ylabel('Handle velocity [deg/s]')
xlabel('Time [s]')
grid on