...
q_home = np.array([0, -0.934, 0.0, -2.23, 0.0, joint6_angle, joint7_angle])
...
trajectory = np.load("/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/efficold/traiettorie/traiettoria_porta.npy")
...
close_index     = 0
TRAJ_WAIT       = 5 # steps before moving to next point
traj_wait_timer = 0
