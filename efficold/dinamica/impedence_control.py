...
model = mujoco.MjModel.from_xml_path(
    "/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/efficold/efficold.xml"
)
...
#
# where:
# q_des is the desired joint position sent through data.ctrl
# Kq is the joint stiffness
# Dq is the joint damping
#
# In MuJoCo this is implemented through:
# gainprm[0] = Kq
# biasprm[1] = -Kq
# biasprm[2] = -Dq
# ============================================================
...
def set_joint_impedance(Kq, Dq, force_limit):
    """
    Set joint-space impedance parameters for the arm actuators.

    The resulting joint torque behaves as:

        tau = Kq * (q_des - q) - Dq * qdot

    where q_des is given by data.ctrl.
    """
...
# Joints used by inverse kinematics
ik_joint_names = [
    "joint1",
    "joint2",
    "joint3",
...
trajectory = np.load(
    "/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/efficold/traiettorie/traiettoria_porta.npy"
)

OPEN_DEG = 62

n_points_open = int(len(trajectory) * OPEN_DEG / 120)
...
# It is only used to generate q_des through inverse kinematics.
# The impedance behavior is implemented at joint level by the actuators.
# ============================================================
...
def solve_position_ik(target, gain):
    ...
    The function computes a Cartesian position error at the grasp_site
    and transforms it into a joint update through the Jacobian.

    The output is not a torque.
    It only updates q_des_ik, which is then used as equilibrium position
    for the joint-space impedance controller.
    """
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    for step in range(30000):
        ...
        # ========================================================
        # q_des_all is the equilibrium position of the joint-space
    ...
    # ============================================================
    # OPTIONAL: KEEP VIEWER OPEN AT THE END
    # ============================================================
    """
