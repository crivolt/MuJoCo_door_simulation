...
# LOAD MODEL
MODEL_PATH = "/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/electric_solution/astana_P/astana_P_ele.xml"
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running():
        ...
        if phase == OPEN_SX:
            ...
            theta_des_sx = phase_start_angle_sx + s * (OPEN_RAD - phase_start_angle_sx)

            model.dof_frictionloss[door_sx_dofadr] = (FRICTION_CLOSED if door_sx_angle < np.deg2rad(1.0) else FRICTION_MOVING)
        ...
        # PHASE 1: WAIT WITH LEFT DOOR OPEN
            ...
            error_sx = OPEN_RAD - door_sx_angle
        ...
        # PHASE 4: OPEN RIGHT DOOR
            ...
            s = smoothstep(phase_timer / T_OPEN)
            theta_des_dx = phase_start_angle_dx + s * (OPEN_RAD - phase_start_angle_dx)

            model.dof_frictionloss[door_sx_dofadr] = FRICTION_CLOSED
            model.dof_frictionloss[door_dx_dofadr] = (FRICTION_CLOSED if door_dx_angle < np.deg2rad(1.0) else FRICTION_MOVING)
        ...
        # PHASE 5: WAIT WITH RIGHT DOOR OPEN
            ...
            error_dx = OPEN_RAD - door_dx_angle
