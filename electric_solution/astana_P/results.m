...
% Load data
data = load("/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/electric_solution/astana_P/dati_porta_meccanica_astana_p.mat");
...
plot(t, motor_pos_sx, "LineWidth", 3.0)
hold on
plot(t, motor_pos_dx, "LineWidth", 3.0)
grid on
xlabel("Time [s]", "FontSize", 30)
...
plot(t, comp_radial_sx, "LineWidth", 3.0)
hold on
