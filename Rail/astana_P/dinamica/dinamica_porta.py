...
model = mujoco.MjModel.from_xml_path("/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/astana_P/Astana_p.xml")
...
door_joint_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_JOINT, "giunto_porta_sx") # CAMBIARE SE VOGLIO LA DX
...
q_home = np.array([0.0, -0.934, 0.0, -2.07, 0.0, joint6_angle, joint7_angle])
...
trajectory = np.load("/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/astana_P/traiettorie/traiettoria_sinistra.npy")

OPEN_DEG = 62

n_points_open = int(len(trajectory) * OPEN_DEG / 95)
...
close_index     = 0
TRAJ_WAIT       = 3 # steps before moving to next point
traj_wait_timer = 0
...
KP             = 1.3    
KI             = 0.10  
INTEGRAL_CLIP  = 0.06   # anti-windup
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    for step in range(30000):
        ...
        match phase:
            ...
            case 5:
                ...
                if step % ik_every == 0:
                    ...
                    if close_index >= len(trajectory_close) - 1 and dist < 0.002:
                        reset_integral()
                        phase = HOLD_CLOSED
        ...
        if step % 50 == 0:
            ...
            print(f"Tempo {time_sec:.2f} | fase {phase} | apertura porta: {door_angle_deg:.2f}°")
