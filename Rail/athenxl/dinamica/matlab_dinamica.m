...
load("/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/Rail/athenxl/dinamica/dati_porta.mat")

idx_sx = porta == 0;
idx_dx = porta == 1;

% Vettori tempo ritagliati
t_sx = tempo(idx_sx);
t_dx = tempo(idx_dx);
...
% ══════════════════════════════
% FIGURE 3 - JOINT TORQUES SX
% ══════════════════════════════

figure("Name", "Joint torques SX")
...
% ══════════════════════════════
% FIGURE 4 - JOINT TORQUES DX
% ══════════════════════════════

figure("Name", "Joint torques DX")
...
% ══════════════════════════════
% FIGURE 5 - CARRIAGE POSITION
% ══════════════════════════════

if exist('slitta', 'var')

    figure("Name", "Carriage position")
    ...
    xlabel("Time [s]", "FontSize", 40)
    ylabel("Slider position [m]", "FontSize", 40)
