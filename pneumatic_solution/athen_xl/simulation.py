...
# LOAD MODEL
model = mujoco.MjModel.from_xml_path("/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/pneumatic_solution/athen_xl/athen_xl_pneumatic.xml")
...
# OPTIONAL BALL JOINTS BETWEEN STEM AND BRACKET
...
FRICTION_CLOSED_SX = 41.9
FRICTION_MOVING_SX = 15.0

FRICTION_CLOSED_DX = 41.9
FRICTION_MOVING_DX = 15.0
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running() and current_cycle < NUM_CYCLES:
        ...
        if phase == OPEN_SX:
            ...
            pos_des_sx = phase_start_pos_sx + s * (OPEN_POS_SX - phase_start_pos_sx)
            pos_des_dx = 0.0
        ...
        # CLOSE LEFT DOOR
            ...
            pos_des_sx = phase_start_pos_sx + s * (0.0 - phase_start_pos_sx)
            pos_des_dx = 0.0
        ...
        # OPEN RIGHT DOOR
            ...
            pos_des_sx = 0.0
            pos_des_dx = phase_start_pos_dx + s * (OPEN_POS_DX - phase_start_pos_dx)
        ...
        # CLOSE RIGHT DOOR
            ...
            pos_des_sx = 0.0
            pos_des_dx = phase_start_pos_dx + s * (0.0 - phase_start_pos_dx)
...
scipy.io.savemat("dati_porta_pneumatica_athen_xl.mat", mat_data)