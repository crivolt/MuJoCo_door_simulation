...
door_joint_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_JOINT, "giunto_porta_dx")
door_qposadr = model.jnt_qposadr[door_joint_id]

# sites

site_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_SITE, "grasp_site")
target_site_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_SITE, "target_manigliadx")
weld_id = mujoco.mj_name2id(model, mujoco.mjtObj.mjOBJ_EQUALITY, "presa_dx")
...
q_home = np.array([0.0, -0.617, 0.0, -2.07, 0.0, 2.64, 0.881])
...
trajectory = np.load("/Users/cristianvoltan/Desktop/unipd/tirocinio/CAD/osaka_3p/traiettorie/traiettoria_destra.npy")
...
q_des_all = data.qpos[all_qposadr].copy()  # TUTTI I GIUNTI
q_des_ik  = data.qpos[ik_qposadr].copy()   # TUTTI I GIUNTI
        ...
        match phase:
            ...
            case 0:
                ...
                if step % ik_every == 0:
                    ...
                    q_des_all[:] = q_des_ik # TUTTI I GIUNTI
